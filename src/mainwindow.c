...
car_editor_t* car_editor_new()
{
    ...
    flag_editor_add_checkbox(editor->flag_editor, "Powered cars accelerate downhill", CAR_COASTS_DOWNHILL);
	...
	flag_editor_add_checkbox(editor->flag_editor, "Dodgem car placement", CAR_FLAG_DODGEM_CAR_PLACEMENT);
	...
	flag_editor_add_checkbox(editor->flag_editor, "Swing Flag 27", CAR_FLAG_27);
