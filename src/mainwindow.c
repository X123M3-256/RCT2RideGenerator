...
static car_editor_t* car_editor_new()
{
    ...
    flag_editor_add_checkbox(editor->flag_editor, "Enable remap color 2",
        CAR_ENABLE_REMAP2);
    ...
    gtk_box_pack_start(GTK_BOX(editor->container), editor->animation_button,
        FALSE, FALSE, 1);
    gtk_box_pack_start(GTK_BOX(editor->container),
        editor->running_sound_editor->container, FALSE, FALSE, 1);
    gtk_box_pack_start(GTK_BOX(editor->container),
        editor->secondary_sound_editor->container, FALSE, FALSE,
        1);
    gtk_box_pack_start(GTK_BOX(editor->container),
        editor->spacing_editor->container, FALSE, FALSE, 1);
    gtk_box_pack_start(GTK_BOX(editor->container),
        editor->friction_editor->container, FALSE, FALSE, 1);
    gtk_box_pack_start(GTK_BOX(editor->container),
        editor->z_value_editor->container, FALSE, FALSE, 1);
...
static header_editor_t* header_editor_new()
{
    ...
    gtk_box_pack_start(GTK_BOX(editor->container),
        editor->track_type_editor->container, FALSE, FALSE, 2);

    editor->flag_editor = flag_editor_new("Flags");
    flag_editor_add_checkbox(editor->flag_editor, "Show as seperate ride",
        RIDE_SEPERATE);
    flag_editor_add_checkbox(editor->flag_editor, "Ride is covered",
        RIDE_COVERED);
    flag_editor_add_checkbox(editor->flag_editor, "Riders get wet", RIDE_WET);
    flag_editor_add_checkbox(editor->flag_editor, "Ride slows down in water",
        RIDE_SLOW_IN_WATER);
    gtk_box_pack_start(GTK_BOX(editor->container), editor->flag_editor->container,
        FALSE, FALSE, 2);
...
static void header_editor_set_project(header_editor_t* editor, project_t* project)
{
    int i;
    editor->project = project;
    track_type_editor_set_track_type(editor->track_type_editor,
        &(project->track_type));
...
static void main_window_set_project(main_window_t* main_window, project_t* project)
{
    ...
    string_editor_set_string(main_window->description_editor,
        &(project->description));
...
main_window_t* main_window_new()
{
    ...
    gtk_box_pack_start(GTK_BOX(main_window->main_hbox), main_window->left_vbox,
        FALSE, FALSE, 2);

    main_window->preview_editor = preview_editor_new();
    gtk_box_pack_start(GTK_BOX(main_window->left_vbox),
        main_window->preview_editor->container, FALSE, FALSE, 2);

    main_window->name_editor = string_editor_new("Name:");
    gtk_box_pack_start(GTK_BOX(main_window->left_vbox),
        main_window->name_editor->container, FALSE, FALSE, 2);

    main_window->description_editor = string_editor_new("Description:");
    gtk_box_pack_start(GTK_BOX(main_window->left_vbox),
        main_window->description_editor->container, FALSE, FALSE,
        2);

    main_window->header_editor = header_editor_new();
    gtk_box_pack_start(GTK_BOX(main_window->main_hbox),
        main_window->header_editor->container, FALSE, FALSE, 2);
